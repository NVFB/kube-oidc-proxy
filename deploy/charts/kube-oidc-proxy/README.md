...
This is a `helm` chart that installs [`kube-oidc-proxy`](https://github.com/TremoloSecurity/kube-oidc-proxy/).
...
[repository](https://github.com/TremoloSecurity/kube-oidc-proxy/blob/master/deploy/yaml/kube-oidc-proxy.yaml).
